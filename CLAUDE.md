...
- Pass commit messages and PR bodies via a file (`git commit -F`, `gh pr create --body-file`), not inline: quoting multi-line prose inside a command string is fragile
