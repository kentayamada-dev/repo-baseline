...
Before reporting, you can use these to see whether something has already been detected. Findings appear under Code scanning on the Security tab.

| Check | What it looks at |
| --- | --- |
| [CodeQL](docs/ci-jobs.md#codeql) | Static analysis of the code (workflow files only in the initial state) |
| [ghalint](docs/ci-jobs.md#ghalint) | Workflow security (how they are written) |
| [zizmor](docs/ci-jobs.md#zizmor) | Workflow security (attack paths) |
| [gitleaks](docs/ci-jobs.md#gitleaks) | Secrets that crept into the commit history |
| [osv-scanner](docs/ci-jobs.md#osv-scanner) | Known vulnerabilities in dependency packages |
